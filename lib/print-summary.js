function printSummary(stats) {
 ...
 console.log("   6. product_suppliers.csv");
 console.log("   7. bulk_discount_plans.csv");
 console.log("   8. bulk_discount_tiers.csv");
 console.log("   9. products.csv");
 console.log("  10. product_variants.csv");
 console.log("  11. product_images.csv");
 ...
 // Calculate average images per variant (for variants that have images)
